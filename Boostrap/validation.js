...
//     document.getElementById("hi").innerHTML = "Please verify the captcha";
...
//     } 
    ...
    function recapcha12() {
        var name = $("#recaptcha").val();
        str= str+"i";
        var response = grecaptcha.getResponse();
        if (response.length == 0) {
            str= str+"l";
            showErrorTooltip("Please verify the captcha","recaptcha-error-tooltip");
        }else{
            str= str+"i";
            hideErrorTooltip("recaptcha-error-tooltip");
        }
    }
