...
<body>
    <div class="body-1">
<div class="card mb-3" style="max-width:640px;height:260px;">
...
<i style="font-size:24px" class="fa">&#xf095;</i>  <label id="phone" ></label><br> 

<a href="EmployeeView.php"><i class="fa fa-arrow-left" aria-hidden="true"></i>back</a>
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title" id="pname" ></h5><br>
